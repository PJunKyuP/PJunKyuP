...
M.S. student in **Smart City at Gachon University**.

My research focuses on transportation and mobility data analysis using
machine learning, big data, and data-driven approaches.

**Research Interests**

`Transportation Big Data` `Mobility Prediction` `Public Transit`
`Machine Learning` `ITS` `Autonomous Vehicles`
...
| Date          | Award                | Project / Competition                                                  |
| ------------- | -------------------- | ---------------------------------------------------------------------- |
...
2025 Korean Society of ITS Spring Conference
